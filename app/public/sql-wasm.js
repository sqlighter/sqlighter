  ...
  initSqlJsPromise = new Promise(function (resolveModule, reject) {
    ...
    e.onRuntimeInitialized = function () {
      ...
      function b(h, l) {
        ...
        l = aa(h) + 1
        this.cb = da(l)
        if (null === this.cb) throw Error("Unable to allocate memory for the SQL string")
        k(h, n, this.cb, l)
        this.ib = this.cb
      ...
      function c(h) {
        ...
        if (null != h) {
          ...
          if (h) {
            if ("string" === typeof h) {
              for (var p = Array(h.length), z = 0, N = h.length; z < N; ++z) p[z] = h.charCodeAt(z)
              h = p
            }
            ha(q, l | 146)
            p = ia(q, 577)
      ...
      var d = x(4),
        ...
        u = f("sqlite3_prepare_v2", "number", ["number", "string", "number", "number", "number"]),
        C = f("sqlite3_sql", "string", ["number"]),
        I = f("sqlite3_normalized_sql", "string", ["number"]),
        ba = f("sqlite3_prepare_v2", "number", ["number", "number", "number", "number", "number"]),
        ic = f("sqlite3_bind_text", "number", ["number", "number", "number", "number", "number"]),
        qb = f("sqlite3_bind_blob", "number", ["number", "number", "number", "number", "number"]),
        ...
        Fc = f("sqlite3_result_text", "", ["number", "string", "number", "number"]),
        Gc = f("sqlite3_result_blob", "", ["number", "number", "number", "number"]),
      ...
      a.prototype.getColumnNames = function () {
        for (var h = [], l = oc(this.Qa), q = 0; q < l; q += 1) h.push(uc(this.Qa, q))
        return h
      }
          ...
          for (h = []; 0 !== v(ja, "i8"); ) {
            ...
            if (0 !== D) {
              ...
              for (null != l && z.bind(l); z.step(); )
                null === N && ((N = { columns: z.getColumnNames(), values: [] }), h.push(N)),
        ...
        var q = va(function (p, z, N) {
          for (var G, ja = [], ca = 0; ca < z; ca += 1) {
            ...
            if (1 === O || 2 === O) D = Dc(D)
              ...
              D = Ac(O)
              O = Cc(O)
              for (var wb = new Uint8Array(D), Aa = 0; Aa < D; Aa += 1) wb[Aa] = y[O + Aa]
              D = wb
            } else D = null
            ja.push(D)
          }
          ...
          switch (typeof G) {
            ...
            case "object":
              null === G
                ...
                : tb(p, "Wrong API use : tried to return a value of an unknown type (" + G + ").", -1)
              break
            default:
              sb(p)
          }
    ...
    if (Ba)
      ...
      za
        ...
        (E = 0 !== E.indexOf("blob:") ? E.substr(0, E.lastIndexOf("/") + 1) : ""),
        (Ca = function (a) {
      ...
      if (Ja.has(a)) a = Ja.get(a)
        ...
        try {
          ...
          if ("function" === typeof WebAssembly.Function) {
            ...
            d[1] = d.length - 2
            c = new Uint8Array(
              [0, 97, 115, 109, 1, 0, 0, 0].concat(d, [2, 7, 1, 1, 101, 1, 102, 0, 0, 7, 5, 1, 1, 102, 0, 0])
            )
    ...
    var R = {
        ...
        createNode: function (a, b, c, d) {
          ...
          R.Ua ||
            (R.Ua = {
              ...
              file: {
                ...
                stream: { Ya: R.Ma.Ya, read: R.Ma.read, write: R.Ma.write, rb: R.Ma.rb, gb: R.Ma.gb, hb: R.Ma.hb },
              },
              link: { node: { Ta: R.La.Ta, Sa: R.La.Sa, readlink: R.La.readlink }, stream: {} },
          ...
          S(c.mode)
            ...
            : 32768 === (c.mode & 61440)
            ? ((c.La = R.Ua.file.node), (c.Ma = R.Ua.file.stream), (c.Ra = 0), (c.Na = null))
            : 40960 === (c.mode & 61440)
            ? ((c.La = R.Ua.link.node), (c.Ma = R.Ua.link.stream))
            : 8192 === (c.mode & 61440) && ((c.La = R.Ua.vb.node), (c.Ma = R.Ua.vb.stream))
        ...
        Ma: {
          ...
          write: function (a, b, c, d, f, g) {
            ...
            if (b.subarray && (!a.Na || a.Na.subarray)) {
              ...
              if (0 === a.Ra && 0 === f) return (a.Na = b.slice(c, c + d)), (a.Ra = d)
      ...
      for (d = 0; d < a.length; d++) {
        ...
        if (!g || b.Xa)
          for (g = 0; 40960 === (f.mode & 61440); )
            if (((f = Qb(c)), (c = zb(vb(c), f)), (f = W(c, { qb: b.qb }).node), 40 < g++)) throw new Q(32)
      }
      return { path: c, node: f }
    }
    function Rb(a) {
      for (var b; ; ) {
        if (a === a.parent) return (a = a.Va.Ab), b ? ("/" !== a[a.length - 1] ? a + "/" + b : a + b) : a
        b = b ? a.name + "/" + b : a.name
        a = a.parent
      }
    }
    ...
    function ia(a, b, c, d) {
      ...
      if (
        !f &&
        (c = g ? (40960 === (g.mode & 61440) ? 32 : S(g.mode) && ("r" !== Xb(b) || b & 512) ? 31 : Ub(g, Xb(b))) : 44)
      )
        throw new Q(c)
      b & 512 && Jc(g, 0)
      b &= -131713
      ...
      !e.logReadFiles ||
        b & 1 ||
        (Lc || (Lc = {}), a in Lc || ((Lc[a] = 1), H("FS.trackingDelegate error on read file: " + a)))
      try {
      ...
      y: function (a, b) {
        try {
          ...
          if (b & -8) var c = -28
            ...
            var d
            ;(d = W(a, { Xa: !0 }).node)
              ? ((a = ""), b & 4 && (a += "r"), b & 2 && (a += "w"), b & 1 && (a += "x"), (c = a && Ub(d, a) ? -2 : 0))
              : (c = -44)
          }
          return c
        } catch (f) {
          ...
          a: {
            ...
            if (0 !== (d & 16) && 0 !== a % 65536) var t = -28
              ...
              if (0 !== (d & 32)) {
                ...
                var C = g
                if (0 !== (c & 2) && 0 === (d & 2) && 2 !== (u.flags & 2097155)) throw new Q(2)
    ...
    function dd() {
      function a() {
        if (!bd && ((bd = !0), (e.calledRun = !0), !Pa)) {
          e.noFSInit ||
            ...
            e.stdout ? Qc("stdout", null, e.stdout) : ec("/dev/tty", "/dev/stdout"),
            e.stderr ? Qc("stderr", null, e.stderr) : ec("/dev/tty1", "/dev/stderr"),
            ia("/dev/stdin", 0),
            ia("/dev/stdout", 1),
            ia("/dev/stderr", 1))
          Pb = !1
      ...
      if (!(0 < cb)) {
        if (e.preRun) for ("function" == typeof e.preRun && (e.preRun = [e.preRun]); e.preRun.length; ) bb()
        jb(Za)
        0 < cb ||
          (e.setStatus
            ? (e.setStatus("Running..."),
