...
export default function PrivacyPolicyPage() {
  return (
    <Layout title="Privacy Policy" subtitle="We respect your privacy">
      ...
      <p>
        We may ask for personal information which may include one or more of the following: Name, email, date of birth,
        sex, values of your biomarkers, etc. We only collect and use your personal information when we have a legitimate
        reason for doing so. In which instance, we only collect personal information that is reasonably necessary to
        provide our services so that we can customise or personalise your experience of our website.
      </p>
